    ...
    <div class="container">
        <div class="sub-title">
            <p>
                ...
                Diễn họa mô hình Cơ điện bằng Lumion & Premiere Pro
            </p>
            <h2>Diễn họa mô hình Cơ điện bằng Lumion & Premiere Pro</h2>
            <p class="descreption">
                Tạo sản phẩm đẹp - Cuốn hút - Chinh phục ngay cả những khán giả khó
                tính nhất!
            </p>
        </div>
    </div>
                ...
                @if ($course->teacher)                 
                    <div class="course-video mb-4" id="author">
                        <div class="d-flex">
                            ...
                            <img src="{{$course->teacher?->image}}" class="rounded-circle" style="width: 80px">
                            </div>
